...
class DataGrid {
  ...
  constructor(target: HTMLElement, options: any) {
    ...
    this.containerOriginX = 0;
    this.containerOriginY = 0;
  ...
  setLayoutSize(options = {}) {
    const el = this.target.parentElement as HTMLElement;
    const rootEl = el.parentElement as HTMLElement;
